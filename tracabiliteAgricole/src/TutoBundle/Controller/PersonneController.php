...
use TutoBundle\Entity\Personne;
...
class PersonneController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $personnes = $em->getRepository('TutoBundle:Personne')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('TutoBundle\Form\PersonneType', $personne);
    ...
    {
        $deleteForm = $this->createDeleteForm($personne);
        $editForm = $this->createForm('TutoBundle\Form\PersonneType', $personne);
