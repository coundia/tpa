...
class PersonneController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $personnes = $em->getRepository('TpaBundle:Personne')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('TpaBundle\Form\PersonneType', $personne);
    ...
    {
        $deleteForm = $this->createDeleteForm($personne);
        $editForm = $this->createForm('TpaBundle\Form\PersonneType', $personne);
